...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_5_kitkat
...
./tools/mac/adb push ./root/$n_root_files /sdcard/
sleep 1
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_5
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_5_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_5_lollipop
ls images/$n_recovery_twrp_nexus_5 >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./images/$n_root_nexus_6_lollipop
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_6
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_7_2012_wifi_kitkat(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2012_wifi_kitkat
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2012_wifi
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_7_2012_wifi_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2012_wifi_lollipop
ls images/$n_recovery_twrp_nexus_7_2012_wifi >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2012_mobile_kitkat
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2012_mobile
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_7_2012_mobile_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2012_mobile_lollipop
ls images/$n_recovery_twrp_nexus_7_2012_mobile >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2013_wifi_kitkat
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2013_wifi
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_7_2013_wifi_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2013_wifi_lollipop
ls images/$n_recovery_twrp_nexus_7_2013_wifi >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2013_mobile_kitkat
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2013_mobile
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_7_2013_mobile_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_7_2013_mobile_lollipop
ls images/$n_recovery_twrp_nexus_7_2013_mobile >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_9_lte_lollipop
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_9
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_9_wifi_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_9_wifi_lollipop
ls images/$n_recovery_twrp_nexus_9 >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_10_kitkat
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_10
echo "Recovery Mode Manually install the Root File"
}

f_root_nexus_10_lollipop(){
#./tools/mac/adb reboot-bootloader 2> /dev/null
#./tools/mac/fastboot boot ./root/$n_root_nexus_10_lollipop
ls images/$n_recovery_twrp_nexus_10 >/dev/null 2>&1
if [ $? -eq 0 ]; then
    echo ""
else
...
./tools/mac/adb reboot-bootloader
sleep 1
./tools/mac/fastboot boot ./images/$n_recovery_twrp_oneplus_one
echo "Recovery Mode Manually install the Root File"
}
...
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot erase boot
./tools/mac/fastboot erase cache
./tools/mac/fastboot erase recovery
./tools/mac/fastboot erase system
./tools/mac/fastboot erase userdata
./tools/mac/fastboot flash bootloader ./images/$n_images_file/$n_bootloader
./tools/mac/fastboot reboot-bootloader
sleep 5
./tools/mac/fastboot flash radio ./images/$n_images_file/$n_radio
./tools/mac/fastboot reboot-bootloader
sleep 5
./tools/mac/fastboot -w update ./images/$n_images_file/$n_image
}
...
#wget -cP images $l_recovery_twrp_oneplus_one
#./tools/mac/adb push ./images/$n_android_oneplus_one_cm11 /sdcard/
#./tools/mac/adb reboot-bootloader
#./tools/mac/fastboot boot ./images/$n_recovery_twrp_oneplus_one
...
#wget -cP images $l_recovery_twrp_oneplus_one
#./tools/mac/adb push ./images/$n_android_oneplus_one_cm12 /sdcard/
#./tools/mac/adb reboot-bootloader
#./tools/mac/fastboot boot ./images/$n_recovery_twrp_oneplus_one
#echo "Recovery Mode Manually install the Android"
echo -e "\
...
./tools/mac/adb push ./images/$n_nethunter_nexus_5_kitkat /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_5
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_5_lollipop /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_5
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_6_lollipop /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_6
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_7_2012_kitkat /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2012_wifi
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_7_2012_lollipop /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2012_wifi
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_7_2013_kitkat /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2013_wifi
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_7_2013_lollipop /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_7_2013_wifi
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_9_lollipop /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_9
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_10_kitkat /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_10
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_nexus_10_lollipop /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_nexus_10
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_oneplus_one_cm11 /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_oneplus_one
echo "Recovery Mode Manually install the NetHunter"
}
...
echo "Uploading NetHunter ..."
./tools/mac/adb push ./images/$n_nethunter_oneplus_one_cm12 /sdcard/
./tools/mac/adb reboot-bootloader
./tools/mac/fastboot boot ./images/$n_recovery_twrp_oneplus_one
echo "Recovery Mode Manually install the NetHunter"
}
...
f_look_device(){
./tools/mac/adb reboot-bootloader 2> /dev/null
./tools/mac/fastboot oem lock
}

f_reboot_system(){
./tools/mac/adb reboot 2> /dev/null
./tools/mac/fastboot reboot 2> /dev/null
}

f_backup_system(){
./tools/mac/adb backup -apk -obb -shared -all -system -f ./images/Android_System_$(date +%F-%H-%M).bak
}

f_restore_system(){
#n_backup_system=$(cd ./images/; ls | sed 's/  /\n/g' | grep ^Android_System)
#
#./tools/mac/adb restore $
echo 'Please Enter "Backup System" File Path or [q]uit'
echo ""
read -p "File: " l_backup_system_link
case $l_backup_system_link in
q) exit 1 ;;
*) ./tools/mac/adb restore $l_backup_system_link ;
esac
}
...
q) exit 1 ;;
*) ./tools/mac/adb reboot-bootloader 2> /dev/null; ./tools/mac/fastboot boot $l_recovery_link ;
esac
}

f_fastboot_mode(){
./tools/mac/adb reboot-bootloader 2> /dev/null
./tools/mac/fastboot reboot-bootloader 2> /dev/null
}
...
case $l_recovery_link in
q) exit 1 ;;
*) ./tools/mac/adb reboot-bootloader 2> /dev/null; ./tools/mac/fastboot flash recovery $l_recovery_link ;
esac
}

f_adb_cmd(){
clear
export PATH=$PATH:$(pwd)/tools/mac
echo -e "\n\
...
chmod 755 ./tools/mac/{adb,fastboot,dmtracedump,etc1tool,hprof-conv,sqlite3}
./tools/mac/adb start-server
f_interface
